...
import com.wx.kernel.util.HttpKit;
...
public abstract class MsgController extends BaseController {
	...
	private void renderText(String text, String string) {
		this.writeText(getResponse(), text);
	}

	private String getPara(String arg0) {
		return this.getRequest().getParameter(arg0);
	}
